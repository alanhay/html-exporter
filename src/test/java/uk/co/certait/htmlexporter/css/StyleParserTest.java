...
public class StyleParserTest {
	...
	public void testParseStyleSheet() throws IOException {
		...
		assertThat(style.getProperty(CssStringProperty.BORDER_BOTTOM_STYLE).get()).isEqualTo(Style.DASHED_BORDER);
		assertThat(style.getProperty(CssStringProperty.BORDER_LEFT_STYLE).get()).isEqualTo(Style.DASHED_BORDER);
		assertThat(style.getProperty(CssStringProperty.BORDER_RIGHT_STYLE).get()).isEqualTo(Style.DASHED_BORDER);
		...
		assertThat(style.getProperty(CssColorProperty.BORDER_TOP_COLOR).get()).isEqualTo(Color.decode("#656565"));
		...
		assertThat(style.getProperty(CssColorProperty.BORDER_TOP_COLOR).get()).isEqualTo(Color.RED);
		assertThat(style.getProperty(CssColorProperty.BORDER_RIGHT_COLOR).get()).isEqualTo(Color.GREEN);
		assertThat(style.getProperty(CssColorProperty.BORDER_BOTTOM_COLOR).get()).isEqualTo(Color.ORANGE);
		assertThat(style.getProperty(CssColorProperty.BORDER_LEFT_COLOR).get()).isEqualTo(Color.CYAN);
		assertThat(style.getProperty(CssStringProperty.BORDER_TOP_STYLE).get()).isEqualTo(Style.DOTTED_BORDER);
		assertThat(style.getProperty(CssStringProperty.BORDER_RIGHT_STYLE).get()).isEqualTo(Style.SOLID_BORDER);
		assertThat(style.getProperty(CssStringProperty.BORDER_BOTTOM_STYLE).get()).isEqualTo(Style.DOUBLE_BORDER);
		assertThat(style.getProperty(CssStringProperty.BORDER_LEFT_STYLE).get()).isEqualTo(Style.DASHED_BORDER);
	}
